import { useBookedSlots } from "@/hooks/use-interviews";
import { INTERVIEW_TYPES, getAvailableTimeSlots, getNext5Days } from "@/lib/utils";
...
function SlotSelectionStep({
  ...
  const { data: bookedSlots = [] } = useBookedSlots(selectedMentorId, selectedDate);
    ...
    <div className="space-y-6">
      ...
      {selectedType && selectedDate && selectedTime && (
        <div className="flex justify-end">
          <Button onClick={onContinue}>Review Interview</Button>
        </div>
      )}
    </div>
  );
