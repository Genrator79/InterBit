...
export interface InterviewConfirmationModalProps {
  open: boolean;
...
export function InterviewConfirmationModal({
  open,
  onOpenChange,
  interviewDetails,
          ...
          <div className="flex flex-col items-center space-y-3">
            ...
            <div className="text-center space-y-1">
              ...
              {interviewDetails?.userEmail && (
                <p className="text-xs text-muted-foreground">{interviewDetails.userEmail}</p>
              )}
            </div>
          </div>
