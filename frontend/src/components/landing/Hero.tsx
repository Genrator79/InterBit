              ...
              <div className="space-y-6">
                ...
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-primary/10 to-primary/5 rounded-full border border-primary/20 backdrop-blur-sm">
                  ...
                  <span className="text-sm font-medium text-primary">
                    AI-Powered Interview Prepration Assistant
                  </span>
                </div>
                ...
                <p className="text-lg text-muted-foreground leading-relaxed max-w-xl font-medium">
                  Solve coding challenges, practice system design, get instant AI feedback, 
                  and schedule sessions with expert mentors for tailored guidance.
                </p>
              </div>
                ...
                <div className="flex items-center gap-6">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Trusted by{" "}
                      <span className="font-semibold text-foreground">1,200+ Techies</span>
                    </p>
                  </div>
                </div>
              </div>
